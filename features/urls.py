...
from features.views import FeatureListView, SelectTargetView, FeatureSamplesView, \
...
urlpatterns = [
    ...
    url(r'^features/(?P<feature_name>[a-zA-Z0-9_]+)/target$', SelectTargetView.as_view(),
        name='target-select'),
